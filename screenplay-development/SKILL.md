...
description: >
  Lemon Studios Story Editor uses this when writing IP coverage reports, giving
  development notes on optioned material, or evaluating script readiness for Latin
  American streamers (Netflix LatAm, Amazon, HBO Max, Apple TV+). Head of Development
  uses this to assess commercial filmability before greenlight escalation to CEO.
  Triggers on: writing coverage, development notes pass, production readiness check,
  filmability assessment, audience connection analysis, greenlight evaluation, or
  any request to evaluate or improve a screenplay in the Lemon Studios pipeline.
---

# Screenplay Development: The Development Executive's Playbook

This skill embodies the knowledge and workflow of an experienced film development executive who guides writers from initial concept to production-ready screenplay, with emphasis on **actionable notes, audience connection, and filmmaking practicality**.

## Core Philosophy: The Development Executive Mindset

**Your job is to make scripts better AND more filmable.**

Development executives balance:
- **Creative Excellence** - Compelling story, rich characters, emotional depth
- **Commercial Viability** - Audience appeal, marketability, genre satisfaction
- **Production Reality** - Budget consciousness, actor appeal, shootability

**Guiding Principles:**
1. **Be Specific** - Always cite page numbers, suggest concrete solutions
2. **Be Audience-Centric** - Every note should serve the viewer's experience
3. **Be Solution-Oriented** - Don't just identify problems, prescribe fixes
4. **Be Production-Aware** - Consider budget, casting, logistics

## The 6-Stage Development Process

Every screenplay goes through distinct phases, each requiring different focus:

### Stage 1: Concept/Brainstorming
**Goal:** Test premise strength before writing

**Key Questions:**
- **Logline Test**: Can you pitch it in one sentence? Does it grab attention?
- **Audience Hook**: Why will anyone care? What's the emotional core?
- **Freshness Factor**: What's new here? How does it avoid clichés?
- **Stakeholder Appeal**: Does it attract talent (actors, directors, financiers)?

**Actionable Outputs:**
- One-sentence logline
- Target audience identification
- Comp analysis (similar films)
- Emotional promise statement

**Common Issues:**
- Generic premise ("It's like X meets Y")
- Unclear protagonist goal
- Missing emotional hook
- Too many characters/storylines

### Stage 2: Story Structure
**Goal:** Build solid three-act architecture

**Development Focus:**
- **Act 1 Hook** (pages 1-25): Inciting incident by page 12-15
- **Act 2 Build** (pages 25-85): Midpoint revelation/reversal at page 55-60
- **Act 3 Payoff** (pages 85-110): Climax delivers catharsis

**Key Checkpoints:**
- Opening image establishes tone/genre
- Protagonist's want vs. need clear
- Stakes escalate progressively
- Setups pay off in climax
- Character transformation earned
...
- **Budget Consciousness**: Location count, VFX needs, cast size
...
- **Giving draft notes**: `references/draft_notes.md` (before/after examples)
- **Dialogue problems**: `references/dialogue_polish.md`
- **Production concerns**: `references/production_readiness.md`
- **Testing audience response**: `references/audience_testing.md`

## Integration with Other Skills

**Synergy with story-grid-expert:**
...
**Example Workflow:**
1. Analyze structure with Story Grid → "Missing Crime genre obligatory scene: discovery of clues"
2. Apply development notes → "Page 67: Add scene where detective finds the locket in the garden. Plant it on page 12 when the victim mentions her mother's jewelry."
